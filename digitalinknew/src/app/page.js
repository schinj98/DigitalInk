...
export default function Home() {
  ...
  return (
   <>
      ...
      <div className="h-full w-full text-[#fdf0d5] flex flex-col justify-center items-center
      
      sm:h-full sm:w-full sm:text-[#fdf0d5] sm:flex sm:flex-col sm:justify-center sm:items-center
      
      md:h-full md:w-full md:text-[#fdf0d5] md:flex md:flex-col md:justify-center md:items-center
      
      lg:h-full lg:w-full lg:text-[#fdf0d5] lg:flex lg:flex-col lg:justify-center lg:items-center
      
      xl:h-full xl:w-full xl:text-[#fdf0d5] xl:flex xl:flex-col xl:justify-center xl:items-center
      
      2xl:h-full 2xl:w-full 2xl:text-[#fdf0d5] 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center">
        
        <h1 className="my-8 text-4xl font-bold
        
        sm:my-8 sm:text-6xl sm:font-bold
        
        md:my-8 md:text-6xl md:font-bold
        
        lg:my-8 lg:text-6xl lg:font-bold
        
        xl:my-8 xl:text-6xl xl:font-bold
        
        2xl:my-8 2xl:text-6xl 2xl:font-bold">DIGITAL INK</h1>
        ...
        2xl:text-base 2xl:mt-8 2xl:h-8 2xl:w-28 2xl:text-[#223029] 2xl:font-bold 2xl:bg-[#fdf0d5] 2xl:rounded-md 2xl:hover:bg-[#223029] 2xl:hover:text-[#fdf0d5] 2xl:hover:border-2 2xl:hover:border-[#fdf0d5]" onClick={clearBoard}>Clear Board</button>

        <div className="w-[100%] my-8 flex flex-col justify-evenly items-center
        ...
        2xl:w-[70%] 2xl:my-8 2xl:flex 2xl:flex-row 2xl:justify-evenly 2xl:items-center">
              ...
              <h1 className="text-xs my-3 mx-4 font-bold
              ...
              <input type="range" name="" id="" min={1} max={10} value={penSize}  onChange={ (e) => setPenSize(e.target.value) } className="w-32 hover:cursor-pointer sm:w-32 sm:hover:cursor-pointer md:w-16 md:hover:cursor-pointer lg:w-[50%] lg:hover:cursor-pointer  xl:hover:cursor-pointer 2xl:hover:cursor-pointer" />

              <h1 className="font-bold mx-4 my-2
              ...
              2xl:font-bold 2xl:mx-4" >{penSize}</h1>
              </div> 
            

            <label className="my-4 inline-flex items-center cursor-pointer
            ...
            2xl:mx-4 2xl:inline-flex 2xl:items-center 2xl:cursor-pointer">
              ...
              <input type="checkbox" value="" className="sr-only peer" checked={eraserSelect} onChange={eraserClicked} />

              <span className="mx-3 text-sm font-bold text-[#fdf0d5]
              ...
              2xl:mx-2 2xl:text-sm 2xl:font-bold 2xl:text-[#fdf0d5] ">PEN</span>

              <div className="relative w-11 h-6 mx-0 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#fdf0d5] dark:peer-focus:ring-[#fdf0d5] rounded-full peer dark:bg-[#344e41] peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-[#fdf0d5] after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-[#fdf0d5] after:border-[#fdf0d5] after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#344e41]
              ...
              2xl:mx-2 2xl:text-sm 2xl:font-bold 2xl:text-[#fdf0d5] ">ERASER</span>
              ...
              2xl:mx-4 2xl:flex 2xl:flex-row">
                ...
                <h1 className="text-xs my-5 mx-2 font-bold
                ...
                2xl:w-24 2xl:text-xs 2xl:my-5 2xl:mx-1 2xl:font-bold">ERASER SIZE</h1>

                <input type="range" name="" id="" min={5} max={20} value={eraserSize} onChange={ (e) => setEraserSize(e.target.value) } className="w-32 hover:cursor-pointer  sm:w-32 sm:hover:cursor-pointer md:w-16 md:hover:cursor-pointer lg:w-[50%] lg:hover:cursor-pointer  xl:hover:cursor-pointer 2xl:hover:cursor-pointer"/>

                <h1 className="mx-2 my-4 font-bold
                ...
                2xl:mx-4 2xl:font-bold">{eraserSize}</h1>

              </div>

            <input type="color" name="" id="" value={penColor} onChange={ (e) => setPenColor(e.target.value) } className="mb-2 w-20 rounded-md hover:cursor-pointer
            ...
            <button className="text-sm my-3 h-8 w-24 text-[#223029] font-bold bg-[#fdf0d5] rounded-md hover:bg-[#223029] hover:text-[#fdf0d5] hover:border-2 hover:border-[#fdf0d5]
            ...
            2xl:text-base 2xl:mx-10 2xl:mb-6 2xl:h-8 2xl:w-28 2xl:text-[#223029] 2xl:font-bold 2xl:bg-[#fdf0d5] 2xl:rounded-md 2xl:hover:bg-[#223029] 2xl:hover:text-[#fdf0d5] 2xl:hover:border-2 2xl:hover:border-[#fdf0d5]" onClick={download}>Download</button>
